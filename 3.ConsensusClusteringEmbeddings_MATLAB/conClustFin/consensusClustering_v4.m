function [clusterConsensus,itemTracker,clusterTracker,exemplarTracker, alignedC] = consensusClustering_v4(inData,nPerms,pItem,kRange,cAlgo,distance,neighbor_num,maxIter,maxReps,center,scale)
...
warning('Debug if using exemplarTracker with subsampling as current output is wrong')
